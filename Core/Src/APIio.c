        ...
        for (int i = 0; i < te_herhalen; i++)
        {
            ...
            switch (type)
            {
                ...
                case CMD_TOREN:
                    ...
                    break;
                case CMD_FIGUUR:
                    figuur(command_buffer[pos+1], command_buffer[pos+2], command_buffer[pos+3],
                           command_buffer[pos+4], command_buffer[pos+5], command_buffer[pos+6],
                           command_buffer[pos+7], command_buffer[pos+8], command_buffer[pos+9],
                           command_buffer[pos+10], get_color_string_from_code(command_buffer[pos+11]));
                    break;
                default: break;
            }
        }
